...
export default function BSCRIM(){
    ...
    const dbref = ref(db, "Subjects/BSCRIM");
    const ins = ref(db, 'Instructors/');
    useEffect(() => {
      const bsitModal = new Modal(document.getElementById('BSCRIM'));
  ...
  useEffect(() => {
    ...
    const BSIT = () => {
        const bsit = new Modal(document.getElementById('BSCRIM'));
        bsit.show();
        setModal(bsit);
    }
    ...
    const Submit = async (e) => {
      ...
      try {
          ...
          if(modal){
            modal.hide();
            const success = new Modal(document.getElementById('successCRIM'));
            success.show();
            setTimeout(() => {
                success.hide();
            }, 1500);
          ...
          const err = new Modal(document.getElementById('errorCRIM'));
    ...
    const ViewInstructors = (subject) => {
        const Instructors = new Modal(document.getElementById('InstructorsCRIM'));
        Instructors.show();
        setInstructors(subject);
      };
      
      const ConfirmationModal = (subject) => {
        const deleteModal = new Modal(document.getElementById('deleteModalCRIM'));
        deleteModal.show();
        setInstructors(subject);
      ...
      const deleteSubject = () => {
        ...
        const subjectRef = ref(db, `Subjects/BSCRIM/${subjectKey}`);
        remove(subjectRef)
            .then(() => {
                ...
                const successModal = new Modal(document.getElementById('successDeleteCRIM'));
                successModal.show();
                setTimeout(() => {
                    successModal.hide();
                    const modalBackdrop = document.querySelector('.modal-backdrop');
            ...
            .catch((error) => {
                ...
                deleteModal.hide();
                const errorModal = new Modal(document.getElementById('errorCRIM'));
                errorModal.show();
                setTimeout(() => {
                    errorModal.hide();
                    const modalBackdrop = document.querySelector('.modal-backdrop');
      ...
      const Instructor = (subject) => {
        ...
        const instructorModal = new Modal(document.getElementById('instructorsCRIM'));
    ...
    return(
        <div className="" id="subjects">
                ...
                <div id="BSCRIM" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                      <div className="modal-header">
                        <div className="modal-title h4">New Subject to BSCRIM</div>
                      </div>
                ...
                <div id="successCRIM" className="modal fade" tabIndex="-1" role="dialog">
                ...
                <div id="successDeleteCRIM" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog">
                    <div className="modal-content">
                      <div className="modal-body text-success">
                ...
                <div id="AssignmentBSCRIM" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                      <div className="modal-body text-success">
                ...
                <div id="errorCRIM" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog">
                    <div className="modal-content">
                      <div className="modal-body text-success">
                ...
                <div id="InstructorsCRIM" className="modal fade p-5" tabIndex="-1" role="dialog">
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                ...
                <div id="deleteModalCRIM" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog modal-dialog-centered">
                ...
                <div id="instructorsCRIM" className="modal fade" tabIndex="-1" role="dialog">
                      ...
                      <div className="modal-body text-success">
                        <center className="text-success">
                          <table className="table table-bordered">
                            ...
                            <tbody>
                            {
                                departmens.some(ins => ins.Department === 'BSCRIM') ? (
                                  departmens
                                    .filter(ins => ins.Department === 'BSCRIM')
                                    .map(ins => (
                                      <tr key={ins.key}>
                                  ...
                                  <tr>
                                    <td colSpan="4">No instructors in the BSCRIM department</td>
                                  </tr>
                                )
                              }
                            </tbody>
