...
export default function BSBA(){
    ...
    const dbref = ref(db, "Subjects/BSBA");
    const ins = ref(db, 'Instructors/');
    useEffect(() => {
      const bsitModal = new Modal(document.getElementById('BSBA'));
  ...
  useEffect(() => {
    ...
    const BSIT = () => {
        const bsit = new Modal(document.getElementById('BSBA'));
        bsit.show();
        setModal(bsit);
    }
    ...
    const Submit = async (e) => {
      ...
      try {
          ...
          if(modal){
            modal.hide();
            const success = new Modal(document.getElementById('successBA'));
            success.show();
            setTimeout(() => {
                success.hide();
            }, 1500);
    ...
    const ViewInstructors = (subject) => {
        const Instructors = new Modal(document.getElementById('InstructorsBA'));
        Instructors.show();
        setInstructors(subject);
      };
      
      const ConfirmationModal = (subject) => {
        const deleteModal = new Modal(document.getElementById('deleteModalBA'));
        deleteModal.show();
        setInstructors(subject);
      ...
      const deleteSubject = () => {
        ...
        const subjectRef = ref(db, `Subjects/BSBA/${subjectKey}`);
        remove(subjectRef)
            .then(() => {
                ...
                const successModal = new Modal(document.getElementById('successDeleteBA'));
                successModal.show();
                setTimeout(() => {
                    successModal.hide();
                    const modalBackdrop = document.querySelector('.modal-backdrop');
            ...
            .catch((error) => {
                ...
                deleteModal.hide();
                const errorModal = new Modal(document.getElementById('errorBA'));
                errorModal.show();
                setTimeout(() => {
                    errorModal.hide();
                    const modalBackdrop = document.querySelector('.modal-backdrop');
      ...
      const Instructor = (subject) => {
        ...
        const instructorModal = new Modal(document.getElementById('instructorsBA'));
    ...
    return(
        <div className="" id="subjects">
                ...
                <div id="BSBA" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                      <div className="modal-header">
                        <div className="modal-title h4">New Subject to BSBA</div>
                      </div>
                ...
                <div id="successBA" className="modal fade" tabIndex="-1" role="dialog">
                ...
                <div id="successDeleteBA" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog">
                    <div className="modal-content">
                      <div className="modal-body text-success">
                ...
                <div id="AssignmentBSBA" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                      <div className="modal-body text-success">
                ...
                <div id="errorBA" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog">
                    <div className="modal-content">
                      <div className="modal-body text-success">
                ...
                <div id="InstructorsBA" className="modal fade p-5" tabIndex="-1" role="dialog">
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                ...
                <div id="deleteModalBA" className="modal fade" tabIndex="-1" role="dialog">
                  <div className="modal-dialog modal-dialog-centered">
                ...
                <div id="instructorsBA" className="modal fade" tabIndex="-1" role="dialog">
                      ...
                      <div className="modal-body text-success">
                        <center className="text-success">
                          <table className="table table-bordered">
                            ...
                            <tbody>
                            {
                                departmens.some(ins => ins.Department === 'BSBA') ? (
                                  departmens
                                    .filter(ins => ins.Department === 'BSBA')
                                    .map(ins => (
                                      <tr key={ins.key}>
                                  ...
                                  <tr>
                                    <td colSpan="4">No instructors in the BSBA department</td>
                                  </tr>
                                )
                              }
                            </tbody>
